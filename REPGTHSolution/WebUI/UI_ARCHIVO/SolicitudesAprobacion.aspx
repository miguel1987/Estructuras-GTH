...
<telerik:RadFormDecorator ID="RadFormDecorator1" runat="server" DecoratedControls="Label,Textbox,select,textarea" Skin="Silk" />
    ...
    <telerik:RadGrid runat="server" ID="rgSolicitudes" AutoGenerateColumns="False" CellSpacing="0"
        ...
        OnItemDataBound="rgSolicitudes_ItemDataBound" OnEditCommand="rgSolicitudes_ApproveCommand" OnDeleteCommand="rgSolicitudes_RejectCommand"
        PageSize="10" AllowPaging="True" AllowFilteringByColumn="True"  AllowSorting="true" Skin="MySilk"         
        ...
        <MasterTableView DataSourceID="ObjectDataSourceSolicitudes" AllowFilteringByColumn="True" CommandItemDisplay="Top" EditMode="EditForms"
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="SOLICITANTE" DataField="SOLICITANTE" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" 
                ...
                <telerik:GridTemplateColumn HeaderText="DESTINATARIO" DataField="DESTINATARIO" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" 
                ...
                <telerik:GridTemplateColumn HeaderText="ESTADO" DataField="ESTADO_DESCRIPCION" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" 
                 ...
                 <telerik:GridBoundColumn DataField="SOLICITANTE_CORREO" DataType="System.Guid" FilterControlAltText="Filter SOLICITANTE_CORREO column"
                    HeaderText="SOLICITANTE_CORREO" SortExpression="SOLICITANTE_CORREO" UniqueName="SOLICITANTE_CORREO" Display="false" ReadOnly="true"
                    ForceExtractValue="Always">
                </telerik:GridBoundColumn> 
                <telerik:GridButtonColumn ConfirmText="¿Está seguro que deseas Aprobar esta solicitud?"
                    ConfirmDialogType="RadWindow" ConfirmTitle="Solicitud Aprobar" ButtonType="ImageButton"
                    CommandName="Edit" Text="Aprobar" UniqueName="AprobarSolicitud" ImageUrl="../Styles/Grid/Edit.gif">
                    <ItemStyle HorizontalAlign="Center" CssClass="MyImageButton"></ItemStyle>
                </telerik:GridButtonColumn>  
                <telerik:GridButtonColumn ConfirmText="¿Está seguro que deseas Rechazar esta solicitud?"
                    ConfirmDialogType="RadWindow" ConfirmTitle="Solicitud Rechazada" ButtonType="ImageButton"
                    CommandName="Delete" Text="Rechazar" UniqueName="RechazarSolicitud" ImageUrl="../Styles/Grid/Delete.gif">
                    <ItemStyle HorizontalAlign="Center" CssClass="MyImageButton"></ItemStyle>
                </telerik:GridButtonColumn>                      
             </Columns>
