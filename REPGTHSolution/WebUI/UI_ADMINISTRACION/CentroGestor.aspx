...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenedor" runat="server">
 ...
 <telerik:RadGrid ID="rgCentroGestor" HorizontalAlign="Center" runat="server" EditMode="InPlace"  
        CellSpacing="0" Culture="es-ES" DataSourceID="odsCentroGestor"
        OnInsertCommand="rgCentroGestor_InsertCommand" OnDeleteCommand="rgCentroGestor_DeleteCommand"
        OnUpdateCommand="rgCentroGestor_UpdateCommand" PageSize="10"
        GridLines="None" AllowPaging="True" Width="50%" 
        OnItemDataBound="rgCentroGestor_ItemDataBound" AllowSorting="true" AllowFilteringByColumn="True"
        EnableEmbeddedSkins="False" Skin="MySilk" ImagesPath="../Styles/Grid/" style="margin: auto">
        <ExportSettings>
            <Pdf PageWidth="" />
        </ExportSettings>
        <MasterTableView
        CommandItemDisplay="Top" DataKeyNames="ID" DataSourceID="odsCentroGestor" AllowFilteringByColumn="True"
            HorizontalAlign="NotSet" AutoGenerateColumns="False" EditMode="EditForms" OverrideDataSourceControlSorting="true">
            <NoRecordsTemplate>
                No existen centros gestores registrados.
            </NoRecordsTemplate>
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="DESCRIPCION" FilterControlAltText="Filter DESCRIPCION column"
                    HeaderText="CENTRO GESTOR" SortExpression="DESCRIPCION" UniqueName="DESCRIPCION" HeaderStyle-Width="350px" 
                    AutoPostBackOnFilter="true" FilterControlWidth="120px" CurrentFilterFunction="Contains" ShowFilterIcon="false">
                    <ColumnValidationSettings EnableRequiredFieldValidation="true">
                        <RequiredFieldValidator ForeColor="Red" Text="*">
                        </RequiredFieldValidator>
                ...
                <telerik:GridButtonColumn ConfirmText="¿Deseas eliminar este Centro Gestor?" ConfirmDialogType="RadWindow"
    ...
    <asp:ObjectDataSource ID="odsCentroGestor" runat="server" SelectMethod="SeleccionarCentrosGestores"         
        TypeName="BusinessLogicLayer.BL_CENTRO_GESTOR" DataObjectTypeName="BusinessEntities.BE_CENTRO_GESTOR">    
