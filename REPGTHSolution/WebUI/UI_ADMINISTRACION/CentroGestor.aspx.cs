...
{
    public partial class CentroGestor : PageBaseClass
    {
        ...
        protected void rgCentroGestor_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridEditableItem && e.Item.IsInEditMode)
            {
                ...
                {
                    BE_CENTRO_GESTOR editableItem = ((BE_CENTRO_GESTOR)e.Item.DataItem);
        ...
        protected void rgCentroGestor_InsertCommand(object sender, GridCommandEventArgs e)
        {
        ...
        protected void rgCentroGestor_UpdateCommand(object sender, GridCommandEventArgs e)
        {
        ...
        protected void rgCentroGestor_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (editableItem.GetDataKeyValue("ID") != null)
                ...
                ID = Guid.Empty;
            BL_CENTRO_GESTOR BL_CENTRO_COSTO = new BL_CENTRO_GESTOR();
            BL_CENTRO_GESTOR.EliminarCentroGestor((Guid)ID);
            rgCentroGestor.DataBind();
        }
        ...
        protected void GrabarActualizar(object sender, GridCommandEventArgs e, String action)
        {
            ...
            BE_CENTRO_GESTOR oentidad = new BE_CENTRO_GESTOR();
            ...
            else
            {
                ...
                oRadComboBox3.EmptyMessage = "<SELECCIONAR>";
                return;
            }
            ...
            if (action == "add")
            {
                ...
                oentidad.ESTADO = 1;
                BL_CENTRO_GESTOR.InsertarCentroGestor(oentidad);
            ...
            else
            {
                oentidad.USUARIO_CREACION = USUARIO;
                oentidad.ESTADO = 1;
                BL_CENTRO_GESTOR.ActualizarCentroGestor(oentidad);
