...
{
    public partial class Orden : PageBaseClass
    {
        ...
        protected void rgOrden_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridEditableItem && e.Item.IsInEditMode)
            {
                ...
                {
                    BE_ORDEN editableItem = ((BE_ORDEN)e.Item.DataItem);
        ...
        protected void rgOrden_InsertCommand(object sender, GridCommandEventArgs e)
        {
        ...
        protected void rgOrden_UpdateCommand(object sender, GridCommandEventArgs e)
        {
        ...
        protected void rgOrden_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            BL_ORDEN.EliminarOrden((Guid)ID);
            rgOrden.DataBind();
        }
        ...
        protected void GrabarActualizar(object sender, GridCommandEventArgs e, String action)
        {
            ...
            BE_ORDEN oentidad = new BE_ORDEN();
            ...
            if (action == "add")
            {
                ...
                oentidad.ESTADO = 1;
                BL_ORDEN.InsertarOrden(oentidad);
            ...
            else
            {
                oentidad.USUARIO_CREACION = USUARIO;
                oentidad.ESTADO = 1;
                BL_ORDEN.ActualizarOrden(oentidad);
