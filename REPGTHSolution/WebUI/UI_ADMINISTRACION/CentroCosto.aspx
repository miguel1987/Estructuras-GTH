...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenedor" runat="server">
 ...
 <telerik:RadGrid ID="rgCentroCosto" HorizontalAlign="Center" runat="server" EditMode="InPlace"  
        ...
        OnUpdateCommand="rgCentroCosto_UpdateCommand" PageSize="10"
        GridLines="None" AllowPaging="True" Width="50%" 
        OnItemDataBound="rgCentroCosto_ItemDataBound" AllowSorting="false" AllowFilteringByColumn="True" 
        EnableEmbeddedSkins="False" Skin="MySilk" ImagesPath="../Styles/Grid/" style="margin: auto">
        <ExportSettings>
            <Pdf PageWidth="" />
        </ExportSettings>
        <MasterTableView
        CommandItemDisplay="Top" DataKeyNames="ID" DataSourceID="odsCentroCosto" AllowFilteringByColumn="True"
            HorizontalAlign="NotSet" AutoGenerateColumns="False" EditMode="EditForms" OverrideDataSourceControlSorting="true">
            <NoRecordsTemplate>
                No existen centros de costo registrados.
            </NoRecordsTemplate>
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="DESCRIPCION" FilterControlAltText="Filter DESCRIPCION column"
                    HeaderText="CENTRO DE COSTO" SortExpression="DESCRIPCION" UniqueName="DESCRIPCION" HeaderStyle-Width="350px" 
                    AutoPostBackOnFilter="true" FilterControlWidth="120px" CurrentFilterFunction="Contains" ShowFilterIcon="false">
                    <ColumnValidationSettings EnableRequiredFieldValidation="true">
                        <RequiredFieldValidator ForeColor="Red" Text="*">
                        </RequiredFieldValidator>
                ...
                <telerik:GridTemplateColumn HeaderText="EMPRESA" HeaderStyle-Width="250px" SortExpression="oBE_EMPRESA.DESCRIPCION" DataField="oBE_EMPRESA.DESCRIPCION" UniqueName="oBE_EMPRESA.DESCRIPCION"
                 AutoPostBackOnFilter="true" FilterControlWidth="120px" CurrentFilterFunction="Contains" ShowFilterIcon="false" AllowFiltering="false">
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="GERENCIA" HeaderStyle-Width="250px" SortExpression="oBE_GERENCIA.DESCRIPCION" DataField="oBE_GERENCIA.DESCRIPCION" UniqueName="oBE_GERENCIA.DESCRIPCION" AllowFiltering="false">
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="AREA" HeaderStyle-Width="250px" SortExpression="oBE_AREA.DESCRIPCION" DataField="oBE_AREA.DESCRIPCION" UniqueName="oBE_AREA.DESCRIPCION" AllowFiltering="false" 
                    AutoPostBackOnFilter="true" FilterControlWidth="120px" CurrentFilterFunction="Contains" ShowFilterIcon="false">
                        <ItemTemplate>
                ...
                <telerik:GridButtonColumn ConfirmText="¿Deseas eliminar este Centro de Costo?" ConfirmDialogType="RadWindow"
    ...
    <asp:ObjectDataSource ID="odsCentroCosto" runat="server" SelectMethod="SeleccionarCentrosCostos"         
        TypeName="BusinessLogicLayer.BL_CENTRO_COSTO" DataObjectTypeName="BusinessEntities.BE_CENTRO_COSTO">    
