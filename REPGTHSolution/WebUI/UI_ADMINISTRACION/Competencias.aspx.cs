...
namespace WebUI.UI_ADMINISTRACION
{
    public partial class Competencias : PageBaseClass
    {
        ...
        protected void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            ...
            rgCompetencia.MasterTableView.FilterExpression = "([DESCRIPCION] LIKE \'%" + txtBuscar.Text.Trim() + "%\' OR [CODIGO]LIKE \'%" + txtBuscar.Text.Trim() + "%\' OR [oBE_COMPETENCIA_TIPO.COMPETENCIA_TIPO_DESCRIPCION]LIKE \'%" + txtBuscar.Text.Trim() + "%\')";
