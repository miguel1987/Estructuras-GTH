						...
						<fieldset style="width: 378px; height: 44px;" class="reTableWizardColumns">
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td><tools:EditorSpinBox id="SpinBoxColumns" VisibleInput="false" runat="server" /></td>
									...
									<td style="vertical-align: top;"><tools:EditorSpinBox id="SpinBoxColumnSpan" VisibleInput="false" runat="server" /></td>
								</tr>
							</table>
						</fieldset>
					</td>
			...
			<fieldset style="width: 302px; height: 394px;" class="reTableWizardRows">
				...
				<table border="0" cellpadding="0" cellspacing="0" style="margin: 40px 0 0 6px;">
					<tr>
						...
						<td><tools:EditorSpinBox id="SpinBoxRows" VisibleInput="false" runat="server" /></td>
					</tr>
					<tr>
						...
						<td><tools:EditorSpinBox id="SpinBoxRowSpan" VisibleInput="false" runat="server" /></td>
					</tr>
				</table>
			</fieldset>
		</td>
