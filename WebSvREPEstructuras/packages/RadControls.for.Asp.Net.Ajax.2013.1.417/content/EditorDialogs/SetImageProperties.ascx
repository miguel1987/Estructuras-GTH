	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="0" class="reControlsLayout">
					...
					<td colspan="4">
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<label class="reDialogLabel" style="padding-left: 10px;">
										<span style="width: 80px; margin-top: 5px; display: inline-block; *zoom: 1; *display: inline;">
											<script type="text/javascript">
				...
				<tr>
					<td class="reLabelCell" style="width: 120px;">
						<label class="reDialogLabel" for="ImageTitle">
							<span style="text-align: right;">
								<script type="text/javascript">
					...
					<td class="reControlCell">
						<input type="text" id="ImageTitle" style="width: 165px;" />
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<label class="reDialogLabelShort">
										<span style="text-align: right;">
				...
				<tr id="thumbRow" runat="server" visible="false">
					<td colspan="2">
						<table border="0" cellpadding="0" cellspacing="0" style="margin-left: 88px;">
							<tr>
								<td class="reControlCell">
								...
								<td style="width: 128px;">
									<label class="reDialogLabel" for="chkThumb">
										<span style="text-align: left; width: 125px;">
