...
<style type="text/css">
	.RadForm_Glow .reImageMapPreview,
	.RadForm_Silk .reImageMapPreview {
		width: 300px;
	}
	
	.reDialogImageMapForm {
		width: 330px;
	}
	
	.RadForm_Glow .reDialogImageMapForm,
	.RadForm_Silk .reDialogImageMapForm {
		width: 375px;
	}
	
	.RadForm_Glow .reImageMapChooseImage,
	.RadForm_Glow .reImageMapSelectAreaShape,
	.RadForm_Glow .reImageMapDefineArea,
...
<table cellpadding="0" cellspacing="0" class="reDialog ImageMapEditor" style="width: 100%;">
	<tr>
		<td style="vertical-align: top; padding: 0;" class="reImageMapPreviewWrapper">
			<fieldset class="reImageMapPreview">
				<legend>
					<script type="text/javascript">
						document.write(localization["Preview"]);
					</script>
				</legend>
				<iframe id="ImageMap_ImageMapFrame" style="height: 324px;" src="" height="100%" width="100%" frameborder="0"></iframe>
		...
		<td style="padding: 0; padding-left: 4px;">
			<table cellpadding="0" cellspacing="0" class="reDialogImageMapForm">
				<tr>
					<td>
						<fieldset style="width: 328px;" class="reImageMapChooseImage">
							<legend>
								<script type="text/javascript">
				...
				<tr>
					<td>
						<fieldset id="area_controls" style="width: 328px;" class="reImageMapSelectAreaShape">
							<legend>
								<script type="text/javascript">
				...
				<tr>
					<td>
						<fieldset id="map_props" style="width: 328px;" class="reImageMapDefineArea">
							<legend>
								<script type="text/javascript">
							...
							<table cellpadding="0" cellspacing="0" class="DefineAreaProperties reDefineSize">
								<tr>
									<td>
									...
									<td>
										<input type="text" id="ImageMap_AreaLeft" style="width: 26px;" />
										px
									</td>
									<td>
										<label class="propertyLabel" for="ImageMap_AreaTop" style="width: 80px;">
											<script type="text/javascript">document.write(localization["Top"]);</script>
											:</label>
									</td>
									<td>
										<input type="text" id="ImageMap_AreaTop" style="width: 26px;" />
										px
									</td>
								</tr>
								<tr>
									...
									<td>
										<input type="text" id="ImageMap_AreaWidth" style="width: 26px;" />
										px
									</td>
									<td>
									...
									<td>
										<input type="text" id="ImageMap_AreaHeight" style="width: 26px;" />
										px
									</td>
								</tr>
							</table>
							<table cellpadding="0" cellspacing="0" class="DefineAreaProperties">
								<tr>
									<td>
										<label class="propertyLabel" for="ImageMap_AreaURL" style="width: 80px;">
								...
								<tr>
									<td>
										<label class="propertyLabel" for="ImageMap_AreaTarget" style="width: 80px;">
								...
								<tr>
									<td>
										<label class="propertyLabel" for="ImageMap_AreaComment" style="width: 80px;">
								...
								<tr>
									<td>
										<label class="propertyLabel" for="ImageMap_AreaTitle" style="width: 80px;">
											<script type="text/javascript">document.write(localization["Title"]);</script>
											:</label>
									</td>
									<td>
										<input type="text" id="ImageMap_AreaTitle" style="width: 216px;" />
									</td>
								</tr>
							</table>
							<div style="padding: 9px 0 10px 4px;">
						...
						<table cellpadding="0" cellspacing="0" style="width: 100%; margin-left: -10px;">
							<tr>
