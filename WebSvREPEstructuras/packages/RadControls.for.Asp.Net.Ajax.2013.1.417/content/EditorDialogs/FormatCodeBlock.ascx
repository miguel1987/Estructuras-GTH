...
<table border="0" cellpadding="0" cellspacing="0" class="reDialog FormatCodeBlock" style="width: 698px;">
	<tr>
		<td>
			<fieldset style="width: 694px;" class="reFormatCodeBlockPaste">
				<legend>
					<script type="text/javascript">
			...
			<fieldset style="width: 694px;" class="reFormatCodeBlockOptions">
			...
			<fieldset style="width: 694px;" class="reFormatCodeBlockPreview">
				<legend>
					<script type="text/javascript">
